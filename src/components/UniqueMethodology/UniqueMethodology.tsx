...
interface UniqueMethodologyProps {
  id?: string;
}
export const UniqueMethodology: React.FC<UniqueMethodologyProps> = ({ id }) => {
  return (
    <section className={styles.SectionUniqueMethodology} id={id}>
        ...
        <div className={styles.UniqueMethodologyInfo}>
          <div>
            <Text>
              ...
              аккуратно организованными полками.
            </Text>
            <Text>Наш минимальный словарь — это
              3300 слов, сгруппированных по темам и подгруппам. Это не только
              упрощает процесс обучения, но и значительно повышает эффективность
              запоминания.
            </Text>
          </div>
      ...
      <div className={styles.UniqueMethodologyRow2}>
        <div className={styles.UniqueMethodologyDifference}>
          ...
          <Text>
            ...
            связи между словами, облегчая их запоминание, сохранение и
